...
for (t in 1:10) {
  ...
  block1 <- get_greedy_blocking(block_size, blocking_old1, my_dist)
  Rrep_block1 <- Rrep_get_greedy_blocking(block_size, blocking_old1, my_dist)
  ...
  block2 <- get_greedy_blocking(block_size, blocking_old2, my_dist)
  Rrep_block2 <- Rrep_get_greedy_blocking(block_size, blocking_old2, my_dist)
